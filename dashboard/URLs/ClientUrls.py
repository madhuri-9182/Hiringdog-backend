...
urlpatterns = [
    ...
    path(
        ...
        RecruiterInterviewerAvailabilityView.as_view(),
    ...
    path(
        "packages/",
        ClientCreditPackagePricingView.as_view(),
        name="client-credit-package-pricing",
    ),
    path(
        "transactions/",
        ClientCreditTransactionView.as_view(),
        name="client-credit-transactions",
    ),
    path(
        "wallet/",
        ClientCreditWalletView.as_view(),
        name="client-credit-wallet",
    ),
    path("job-role/", JobRoleView.as_view(), name="job-role"),
    path("job-role/<int:job_role_id>/", JobRoleView.as_view(), name="job-role-details"),
    path("specialization/", StreamView.as_view(), name="streams"),
]
